        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 px-4">
          ...
          <div className="space-y-6 md:space-y-8">
            <div>
              ...
              <div className="space-y-3 md:space-y-4">
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-gray-900 rounded-full mt-2 mr-3 md:mr-4 flex-shrink-0"></div>
            ...
            <div>
              ...
              <div className="space-y-3 md:space-y-4">
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-gray-600 rounded-full mt-2 mr-3 md:mr-4 flex-shrink-0"></div>
                  <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                    フレッシュな視点
                  </p>
                </div>
