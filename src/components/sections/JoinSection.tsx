  ...
  return (
    <Section id="join">
      <div className="max-w-6xl mx-auto">
        ...
        {/* 参加ステップ */}
        <div className="mb-16">
          <h3 className="text-xl font-semibold text-gray-900 mb-12 text-center">
            参加ステップ
          </h3>
          ...
          <div className="bg-gray-900 text-white p-8 rounded-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                ...
                className="inline-flex items-center justify-center px-8 py-4 text-lg font-medium rounded-lg border-2 border-white text-white hover:bg-white hover:text-gray-900 transition-all duration-200"
              >
                公式Xをフォロー
