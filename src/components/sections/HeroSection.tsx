    ...
    return (
        <section id="hero" className="min-h-screen flex items-center justify-center marble-background-alt pt-16 md:pt-0">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                {/* メインキャッチコピー */}
                <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-gray-900 mb-6 md:mb-8 leading-tight drop-shadow-sm">
                    WeCreate3
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center mb-16 md:mb-20 px-4">
                    <Button variant="primary" size="lg" href="#events" className="px-8 sm:px-12 py-4 sm:py-5 text-lg sm:text-xl touch-manipulation">
                        最新イベントに参加する
                    </Button>
                    <Button variant="outline" size="lg" href="#join" className="px-8 sm:px-12 py-4 sm:py-5 text-lg sm:text-xl touch-manipulation">
                        コミュニティに参加する
                    </Button>
                </div>
            </div>
